<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow " data-scroll-to-active="true" data-img="{{ asset('theme-assets/images/backgrounds/02.jpg')}}">
    ...
    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class="active"><a href="{{url('admin/pariwisata')}}"><i class="ft-user"></i><span class="menu-title" data-i18n="">Pariwisata</span></a>
        </li>
        <li class=""><a href="{{url('admin/paket')}}"><i class="ft-user"></i><span class="menu-title" data-i18n="">Paket</span></a>
        </li>
